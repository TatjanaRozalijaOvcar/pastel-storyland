        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="book-card">
            ...
            <div className="prose prose-gray max-w-none mb-6 text-gray-600">
              ...
              <p>Snijegom prekriveno drveće, brežuljak, snjegović i sanjke. Bila je to posljednja slika koja je prošla dječakovim mislima prije nego je utonuo u san. Upravo je to bila ona želja koju je dječak večeras pokušao staviti na papir. Sutra će to zasigurno i učiniti. Već dvije godine za redom nije bilo snijega i sada je Doni odlučio stvar uzeti u svoje ruke. Napisat će pismo Sv. Nikoli i on će mu ispuniti želju! Kako se toga još nitko prije njega nije dosjetio? No, svejedno, sutra će stvar biti riješena. Jedino što je dječaka zabrinjavalo bila je adresa na koju pismo treba poslati.</p>
              ...
              <p>Kada joj je Doni sve lijepo objasnio plan je bio donesen u trenu. Baš danas mama mora na poštu. Ponijet će pismo i poslati ga. A za adresu još će pitati poštara. On sigurno zna svoj posao. Ovih je dana Sv. Nikoli sigurno isporučio puno pisama.</p>
              <p>«Ti samo lijepo napiši pismo prije nego što krenem», rekla je na kraju mama.</p>
              <p>«Koliku kuću mora imati Sv. Nikola da u nju stanu sva ta pisma?»... razmišljao je dječak dok je olovkom ispisivao okrugla debeljuškasta slova.</p>
              <p>Njegovu misao prekinuo je nitko drugi nego njuškom i šapom Muki. Skočivši mu u krilo, pružio je šapicu prema olovci. Ovaj put je Doni ostao ozbiljan. A kada je Muki potom skočio na stol, čak ga je i odgurnuo:</p>
              <p>«Prestani Muki, smetaš mi!»</p>
              <p>Na to je mali mačić podigao repić, njuškicu i uha, na trenutak zastao, a onda poput vihora nestao.</p>
              <p>Nakon što je dovršio pismo, Doni je doručkovao, a onda se toplo obukao i krenuo van. I tek je tada primjetio da Mukija nema. Nije ga bilo u sobi, ni u kuhinji, a niti bilo gdje u kući. «Mora da je već vani», pomislio je i istrčao u dvorište. Ali, mačića ni ondje nije bilo. Doni ga je počeo dozivati i tražiti. Prvo u šupi, onda pod tačkama, zatim ispod kosilice... na kraju otrči do šume. Spustio se i do potoka, pogledom je pretraživao sve krošnje, a rukama razgrtao otpalo lišće. Našao je gliste, mrave, razne bube i dvije žabe. Na grani je ugledao žunu i rep vjeverice za koji mu se načas učinilo da je Mukijev. Na kraju je pod lišćem naišao i na ježa, ali ne i na mačića.</p>
              <p>«Kamo se samo sakrio?», pitao se zabrinuto, dok je nakon jednosatne potrage za prijateljem odvezivao cipele: «Da je tu, sada bi hvatao moje žnirance. Ali vratit će se on do ručka», tješio se ulazeći u kuću.</p>
              <p>Ali Muki se nije vratio. Nije došao na ručak. Nije se vratio niti do večere.</p>
              <p>Poljubivši ga za laku noć, mama je primjetila da su se dječakove oči napunile suzama.</p>
              <p>«Zbog Mukija?» upitala ga je. Doni je kimnuo glavom i jedna se suza skotrljala niz obraz, a onda i druga. Kada ga je majka uzela u naručje, mali potočići nezaustavljivo su tekli dječakovim obrazima.</p>
              ...
              <p>«Baš kao i ti i on ima svog anđela čuvara. Sigurno se pobrinuo za našeg Mukija i smjestio ga negdje gdje je toplo» tješila ga je dalje.</p>
              <p>Ali dječaku je bilo teško, jako teško oko srca.</p>
              <p>«Uvrijedio sam ga, možda se više ne vrati...», i baš kada se nova suza spremala skotrljati niz njegov obraz, začuje se tiho mijaukanje.</p>
              <p>«ŠŠŠŠ!» osluhne mama, razmakne zastore i nasmije se tako radosno i glasno da je i tata dotrčao u Tinovu sobu.</p>
              ...
              <p>«Pa valjda mu je njegov anđeo pomogao» dosjetio se Doni.</p>
              <p>«Hm, to je moguće. U svakom slučaju, sutra ćemo ga okupati» zaključila je rukama skidajući paučinu i nekoliko kuglica prašine s mačića koji je već zagnjurio njuškicu u pokrivač. Sada je Doni mogao mirno zaspati. Uskoro je kućom zavladala noćna tišina.</p>
              <p>Slijedeće jutro, cijeli dan i nekoliko idućih dječak i mačić proveli su u igri. Doni se trudio prisjetiti najdražih Mukijevih igara. Neko vrijeme trčali su šumom, preskakali potok, razgrtali lišće, skrivali se jedan od drugoga u grmlju, čak se i verali po drveću. dječakovi su se obrazi zarumenjeli, a Mukijeve oči su blistale. Od zadovoljstva, ali i od studeni. Iz dana u dan bivalo je hladnije. Jednog je jutra čak i Muki, koji bi inače jedva dočekao prvo jutarnje otvaranje ulaznih vrata, zastao na pragu. Jaki nalet vjetra podigao je dlake mačićevog mekanog krzna. Doni je brzo zaključio kako je danas najbolje ostati u kući, pa je izvukao pikule, stare metalne poklopce za lonce i glatke duguljaste daščice, ostatke tatine najnovije police. Neobični orkestar je bio spreman. Muki se silno veselio ovoj glazbenoj igri. Skakutao je zajedno s pikulama, šapicama ih je gurao i navodio na drveni tobogan, pratio ih na putu do poklopaca, pa ih onda dočekivao sve naginjući njuškicu dok je promatrao krugove i osluškivao zvukove koje su pikule pritom proizvodile.</p>
              <p>Igrali su se tako sve do večeri kada je trebalo očistiti čizmice za darove Sv. Nikole.</p>
              <p>A onda je tu noć pao snijeg. Bila je to prava bijela čarolija. Osobito za Donija, ali i za Mukija. Sve što je mačić još jučer poznavao, odjednom je nestalo. Kao da je netko zamahnuo čarobnim štapićem i sve prekrio nekim čudnim, mokrim i hladnim prekrivačem. Čemu se to Doni veselio, mačiću nikako nije bilo jasno. I dok se dječak glasno smijao trčeći kroz snijeg, njegove su šapice upadale toliko duboko da su mu uskoro i trbuščić i rep, a onda i oba uha bili potpuno mokri. A kada je Doni izvukao sanjke iz šupe, Mukijeva njuškica se već tresla od zime. Hladnoća mu i ne bi toliko naškodila da ga je njegov najbolji prijatelj tada uzeo u naručje. Ma, da ga je uopće primjetio, već bi mu bilo toplije... Ali Doni je bio toliko zaokupljen sanjkama, snjegovićem i drugim snježnim igrama da je na mačića posve zaboravio!</p>
              <p>A kada se Muki nakon ove kratke avanture na snijegu uspio vratiti kući, nekoliko idućih dana nije izlazio, osim u nuždi. Dječakove je igre promatrao sa sigurne udaljenosti, smješten na prozorskoj dasci u toploj sobi. Kada bi se Doni rumen u licu i izmoren vratio u kuću, jedino za što je bio spreman, bio je krevet.</p>
              <p>I tako, dok je dječak ove dane provodio na snijegu u igri ili u postelji na zasluženom odmoru, mačić se - dosađivao. Prvog je dana bio samo malo povrijeđen jer ga Doni nije primjećivao, ali je još uvijek uživao u toplini sobe s prozora promatrajući blještavu bjelinu snijega i dječaka u igri. Drugoga dana već je bio pomalo nestrpljiv u iščekivanju Donijevog povratka u kuću. Trećeg dana se počeo ljutiti dosađujući se na prozorskoj dasci. Peti dan je odlučio nešto poduzeti i krenuo na neko drugo, isto ovako suho, ali novo i zanimljivije mjesto.</p>
              <p>«Kamo je to Muki otišao?», već iste večeri ovo su pitanje postavili i Doni i mama i tata.</p>
              <p>«Budući da naš Muki baš i ne uživa u snijegu, ne bih rekao da je odlutao daleko. Sigurno je negdje u blizini.» razmišljao je tata na glas.</p>
              <p>«Da, ovih je dana često boravio u sobi», potvrdi mama.</p>
              <p>«Kad bolje razmislim, izgledao mi je nekako tužan...», zabrinuo se dječak.</p>
              <p>«Samo se nemoj sada i ti rastužiti. Ujutro ćemo ga potražiti!», završi razgovor tata, a mama položi ruku na Donijevu kosu i doda: »Ne brini, Muki sigurno ima svog anđela čuvara.»</p>
              ...
              <p>«Skuhat ću nam čaj. A onda ćemo razmisliti što dalje», tako je rekla mama ulazeći u kuću, a tata i Doni samo su nijemo kimnuli glavama i bezvoljno sjeli na trosjed. Iz kuhinje se kratko još čuo šum vode i zveckanje šalica, a onda je sve utihnulo. Tišina se spustila na ukućane i zavladala sobom.</p>
              <p>A onda, nenadano, odnekuda, začuo se prigušen zvuk. Pa odmah zatim još jedan, pa još jedan, poput muklih udara malih batića nekog čudnovatog glazbala. Činilo se kao da zvukovi dolaze iz velike daljine. Trenutak kasnije začulo se još nekoliko tonova istovremeno i u nizu. Ton za tonom, sve upornije i jasnije redali su se i polagano oblikovali neobičnu melodiju.</p>
              <p>Tata i mama su se gotovo istovremeno dosjetili:</p>
              <p>«Klavir!», rekla je mama,</p>
              <p>«Na tavanu!», bio je već na nogama tata.</p>
              <p>«Muki!?», razveselio se Doni potrčavši za roditeljima prema hodniku.</p>
              <p>«Možda. Nadamo se», govorila je mama uzimajući dječaka u naručje dok je tata već prisljanjao ljestve uza zid.</p>
              <p>Otvor za tavan bio je otvoren začas, pa je malena obitelj ubrzo stajala na drvenim podnim daskama zadovoljno se smješeći prizoru koji ih je ondje dočekao.</p>
              <p>Slabašna svjetlost zimskog poslijepodneva dopirala je kroz malene pukotine krova blago osvjetljavajući upravo ono što su i očekivali: stari pianino i Mukija na njemu. Mala pahuljasta loptica stajala je na klavirskim tipkama začuđeno promatrajući pridošlice.</p>
              <p>«Naš Muki glazbenik», nježnim glasom tišinu prekine mama.</p>
              <p>«To je moj Muki!», ponosno doda dječak.</p>
              <p>«Hajde, odsviraj nam još nešto», nasmiješi se tata približivši mu se.</p>
              <p>A Muki, taj maleni glazbenik, nakon prvotnog iznenađenja, malo je nagnuo glavicu znatiželjno iščekujući daljnji razvoj događaja. Tako su nekoliko trenutaka svi stajali promatrajući se i iščekujući.</p>
              <p>Svakoga trenutka na tavanu je bivalo sve tamnije i uskoro se nije vidjelo ništa osim obrisa. A onda se konačno začuo jedan ton. Pa još jedan, onda dva odjednom i zatim čitav niz. Doni, mama i tata jedva su išta vidjeli, ali sada su bili sigurni otkuda zvukovi dolaze. Stojeći tamo gore u tami znali su da to njihov pahuljasti mačić hoda amo tamo po klavirskim tipkama i mogli su ga zamisliti kako svojim nježnim rozim šapicama dotiče jednu po jednu i više tipki klavira, proizvodeći najneobičniju, ako ne i najljepšu glazbu koju su ikada čuli.</p>
