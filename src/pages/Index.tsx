        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="book-card">
            ...
            <div className="text-gray-600 mb-4 prose prose-gray max-w-none">
              ...
              <p>«Naš Donija glazbenik», nježnim glasom tišinu prekine mama.</p>
              <p>«To je moj Donija!», ponosno doda Don.</p>
              <p>«Hajde, odsviraj nam još nešto», nasmiješi se tata, svejednako sto jeći na mjestu kako svojim pokretom ne bi uznemirio Donija.</p>
              ...
              <p>Iznad krova kuće na nebu su se pojavile prve zvijezde. Mrak se polako spuštao, a bjelina snijega se uzdizala prema njemu. U krošnji velikog hrasta pojavio se mjesec, a na sniježnom tlu zasvjetlili su kristalići leda. Iako su tišinu večeri prekidali neočekivani zvukovi, priroda i životinje polako su se spremali na počinak. Provlačeći se kroz otvore među crijepovima, Donijeva je mala kompozicija vani zasigurno zvučala kao nježna uspavanka.</p>
            </div>
