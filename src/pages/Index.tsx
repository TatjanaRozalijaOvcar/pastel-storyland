        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="book-card">
            ...
            <div className="text-gray-600 mb-4 prose prose-gray max-w-none">
              ...
              <p>Nekoliko je trenutaka netremice osluškivao žuborenje vode, a onda se već u sljedećem našao ispod velikog hrasta osluškujući i promatrajući ritmične udarce žuninog žutog kljuna o drvo. Na šumskom je tlu zašuštalo jesensko lišće i Muki je već poskočio gurajući njuškicu prema jednom listu koji je odlučio otputovati. Polako, korak po korak, list je zaista klizio. No kada je maćić potom naglo odskočio mijaknuvši, ispod lista se ukazao jež...</p>
              <p>Život u dvorištu i obližnjem šumarku Mukiju je iz minute u minutu donosio nešto novo i uzbudljivo. Cijeli dan znao je provesti u proučavanju, igri i skakutanju. A navečer, kada je bilo vrijeme za ulazak u kuću, smjestio bi se na prozorskoj dasci i još dugo promatrao obrise stabala u noći i osluškivao zvukove dvorišta i šume koji su dopirali iz mraka.</p>
              <p>Sve u svemu, bio je to jedan vrlo znatiželjan mačić. Baš kao i Tin koji se mačićevom dolasku na svijet silno obradovao. Točnije rečeno, on je tom događaju osobno prisustvovao i sa oduševljenjem još dugo nakon toga prepričavao tijek rođenja svojeg kućnog mezimca. Od tada je prošlo skoro cijelo godišnje doba.</p>
              <p>Sada je Muki ležao na prozorskoj dasci, a Tin u krevetu. Dječak je razmišljao o želji koja je još uvijek bila samo u njegovim mislima. Tin je večeras pokušao napisati pismo, ali ga je, kao i obično kada bi sjeo za stol, Muki u tome omeo. Zapravo, mačić je, šapom hvatajući olovku, Tina naveo na smijeh, a onda i na igru s bakinim klupkom vune. Ostatak večeri Tin je proveo raspetljavajući ono što je Muki u dvije minute zamrsio. A Muki? On ga je pozorno promatrao povremeno pružajući šapicu u pokušaju da pomogne.</p>
              <p>Snijegom prekriveno drveće, brežuljak, snjegović i sanjke. Bila je to posljednja slika koja je prošla Tinovim mislima prije nego je utonuo u san. Upravo je to bila ona želja koju je dječak večeras pokušao staviti na papir. Sutra će to zasigurno i učiniti. Već dvije godine za redom snijega za sanjkanje nije bilo, a ove je godine dječak odlučio stvar uzeti u svoje ruke. Napisat će pismo Sv. Nikoli i on će mu ispuniti želju! Kako se toga još nitko prije njega nije dosjetio? No, svejedno, sutra će stvar biti riješena. Jedino što je Tina zabrinjavalo bila je adresa na koju pismo treba nasloviti.</p>
              ...
              <p>Kada joj je Tin sve lijepo objasnio plan je bio donesen u trenu. Baš danas mama mora na poštu. Ponijet će pismo i poslati ga. A za adresu još će pitati poštara. On sigurno zna svoj posao. Uostalom ovih je dana Sv. Nikoli isporučio toliko pisama koliko ima i djece.</p>
              <p>«Ti samo lijepo napiši pismo prije nego što krenem», rekla je na kraju mama.</p>
              <p>«Koliku kuću mora imati Sv. Nikola da u nju stanu sva ta pisma?»... razmišljao je Tin dok je olovkom ispisivao okrugla debeljuškasta slova.</p>
              <p>Njegovu misao prekinuo je nitko drugi nego njuškom i šapom Muki. Skočivši mu u krilo, pružio je šapicu prema olovci. Ovaj put je Tin ostao ozbiljan. A kada je Muki potom skočio na stol, Tin se čak i razljutio, pa je, odgurnuvši ga, povikao:</p>
              ...
              <p>Nakon što je dovršio pismo, Tin je doručkovao, a onda se toplo obukao i krenuo van. I tek je tada primjetio da Mukija nema. Nije ga bilo u sobi, ni u kuhinji, a niti bilo gdje u kući. «Mora da je već vani», pomislio je i istrčao u dvorište. Ali, mačića ni ondje nije bilo. Sada ga je Tin počeo dozivati, pa onda tražiti. Prvo u šupi, onda pod tačkama, zatim ispod kosilice... na kraju otrči do šume. Spustio se i do potoka, pogledom pretražio sve krošnje, rukama razgrtao otpalo lišće. Našao je gliste, mrave, razne bube i dvije žabe. Na grani je ugledao žunu i rep vjeverice za koji mu se načas učinilo da je Mukijev. Na kraju je pod lišćem naišao i na ježa, ali ne i na mačića.</p>
              <p>«Kamo se samo sakrio?», pitao se Tin zabrinuto, dok je nakon jednosatne potrage za prijateljem odvezivao cipele: «Da je tu, sada bi lovio moje žnirance. Ali vratit će se on do ručka», tješio se Tin ulazeći u kuću.</p>
              <p>Ali Muki se nije vratio. Nije došao na ručak. Nije se vratio niti do večere.</p>
              <p>Poljubivši ga za laku noć, mama je primjetila da su se Tinove oči napunile suzama.</p>
              <p>«Zbog Mukija?» upitala ga je. Tin je uspio samo klimnuti glavom i jedna se suza već skotrljala niz obraz, a onda i druga. Kada ga je majka uzela u naručje, mali potočići nezaustavljivo su potekli Tinovim obrazima.</p>
              ...
              <p>«Baš kao i ti i on ima svog anđela čuvara. Sigurno se pobrinuo za našeg Mukija i smjestio ga negdje gdje je toplo» tješila ga je dalje mama.</p>
              <p>Ali Tinu je bilo teško, jako teško oko srca.</p>
              ...
              <p>«Pa valjda mu je njegov anđeo pomogao» dosjetio se Tin.</p>
              <p>«Hm, to je moguće. U svakom slučaju, sutra ćemo ga okupati» zaključila je rukama skidajući paučinu i nekoliko kuglica prašine s mačića koji je već zagnjurio njuškicu u Tinov pokrivač. Sada je Tin mogao mirno zaspati. Uskoro je kućom zavladala noćna tišina.</p>
              <p>Slijedeće jutro, cijeli dan i nekoliko idućih Tin i Muki proveli su u igri. Naravno, Tin se trudio prisjetiti najdražih Mukijevih igara. Neko vrijeme trčali su šumom, preskakali potok, razgrtali lišće, skrivali se jedan od drugoga u grmlju, čak se i verali po drveću. Tinovi su se obrazi zarumenjeli, a Mukijeve oči su blistale. Od zadovoljstva, ali i od studeni. Iz dana u dan bivalo je hladnije. Jednog je jutra čak i Muki, koji bi inače jedva dočekao prvo jutarnje otvaranje ulaznih vrata, zastao na pragu. Jaki nalet vjetra podigao je dlake Mukijevog mekanog krzna i mačić je ustuknuo. Tin je brzo zaključio kako je danas najbolje ostati u kući, pa je izvukao pikule, stare metalne poklopce za lonce i glatke duguljaste daščice, ostatke tatine najnovije police. Neobični orkestar je bio spreman. Muki se silno veselio ovoj glazbenoj igri. Skakutao je zajedno s pikulama, šapicama ih je gurao i navodio na drveni tobogan, pratio ih na putu do poklopaca, pa ih onda dočekivao sve naginjući njuškicu dok je promatrao krugove i osluškivao zvukove koje su pikule pritom proizvodile.</p>
              <p>Igrali su se tako sve do večeri kada je trebalo očistiti čizmice za darove Sv. Nikole.</p>
              <p>A onda je tu noć pao snijeg. Bila je to prava bijela čarolija. Osobito za Tina, ali i za Mukija. Sve što je mačić još jučer poznavao, odjednom je nestalo. Kao da je netko zamahnuo čarobnim štapićem i sve je bilo prekriveno nekim čudnim, mokrim i hladnim prekrivačem. Čemu se to Tin veselio, mačiću nikako nije bilo jasno. I dok se Tin glasno smijao trčeći kroz snijeg, njegove su šapice upadale toliko duboko da su mu uskoro i trbuščić i rep, a onda i oba uha bili potpuno mokri. A kada je Tin izvukao sanjke iz šupe, Mukijeva njuškica se već tresla od zime. Hladnoća mu i ne bi toliko naškodila da ga je njegov najbolji prijatelj tada uzeo u naručje. Ma, da ga je uopće primjetio, već bi mu bilo toplije... Ali Tin je bio toliko zaokupljen sanjkama, snjegovićem i drugim snježnim igrama da je na mačića posve zaboravio!</p>
              <p>A kada se mačić nakon ove kratke avanture na snijegu uspio vratiti kući, nekoliko idućih dana nije izlazio, osim u nuždi. Tinove je igre promatrao sa sigurne udaljenosti, smješten na prozorskoj dasci u toploj sobi. Kada bi se dječak rumen u licu i izmoren vratio u kuću, jedino za što je bio spreman, bio je krevet. I tako, dok je Tin ove dane provodio na snijegu u igri ili u postelji na zasluženom odmoru, Muki se - dosađivao. Prvog je dana bio samo malo povrijeđen jer ga Tin nije primjećivao, ali je još uvijek uživao u toplini sobe s prozora promatrajući blještavu bjelinu snijega i Tina u igri. Drugoga dana već je bio pomalo nestrpljiv u iščekivanju Tinovog povratka u kuću. Trećeg dana se počeo ljutiti dosađujući se na prozorskoj dasci. Peti dan je odlučio nešto poduzeti i krenuo na neko drugo, isto ovako suho, ali novo i zanimljivije mjesto.</p>
              <p>«Kamo je to Muki otišao?», već iste večeri ovo su pitanje postavili i Tin i mama i tata.</p>
              ...
              <p>«Kad bolje razmislim, izgledao mi je nekako tužan...», zabrinuo se Tin.</p>
              <p>«Samo se nemoj sada i ti rastužiti. Ujutro ćemo ga potražiti!», završi razgovor tata, a mama položi ruku na Tinovu kosu i doda: »Ne brini, Muki ima svog anđela čuvara. Sjećaš se?»</p>
              ...
              <p>«Skuhat ću nam čaj. A onda ćemo razmisliti što dalje», tako je rekla mama ulazeći u kuću, a tata i Tin samo su nijemo kimnuli glavama i bezvoljno sjeli na trosjed. Iz kuhinje se kratko još čuo šum vode i zveckanje šalica, a onda je sve utihnulo. Tišina se spustila na ukućane i zavladala sobom.</p>
              ...
              <p>«Muki!?», razveselio se Tin potrčavši za roditeljima prema hodniku.</p>
              ...
              <p>Slabašna svjetlost zimskog poslijepodneva dopirala je kroz malene pukotine krova blago osvjetljavajući upravo ono što su i očekivali: stari crni pianino i Mukija na njemu. Mala pahuljasta loptica stajala je na klavirskim tipkama začuđeno promatrajući pridošlice.</p>
              <p>«Naš Muki glazbenik», nježnim glasom tišinu prekine mama.</p>
              <p>«To je moj Muki!», ponosno doda Tin.</p>
              <p>«Hajde, odsviraj nam još nešto», nasmiješi se tata, svejednako stojeći na mjestu kako svojim pokretom ne bi uznemirio Mukija.</p>
